...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dvg-ringbuffer-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dvg-ringbuffer-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add dvg-ringbuffer
# for installing globally
pixi global install dvg-ringbuffer
```
...
It is possible to list all of the versions of `dvg-ringbuffer` available on your platform:
...
```
pixi search dvg-ringbuffer --channel conda-forge
```
